...
public class PenteProyecto {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            fila=funciones.IntMinMax("Jugador "+JugadorActivo+", introduzca la fila en la que desea añadir su ficha", "La fila introducida no existe", 
        ...
        } while (funciones.casillasLibres(tablero)==true && funciones.comprobarLinea(tablero, fila, columna)!=true);
        if (funciones.comprobarLinea(tablero, fila, columna)==true){
            System.out.println("¡El jugador "+JugadorActivo+" gana! ¡Ha conseguido poner 5 fichas en línea!");
        }
        /*
        No estoy seguro de si quedarme con esto...
        */
        } while(funciones.reiniciarJuego("Desea volver a jugar? Si/No")==true);
    }
}