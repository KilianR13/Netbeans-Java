...
public class leerDouble {
    ...
    public static int leerIntError(String mensaje) {
        Scanner teclado = new Scanner(System.in);
        System.out.println(mensaje);
        while (!teclado.hasNextDouble()) {
            throw new IllegalArgumentException("El valor introducido produce un error");
        }
        int valor = teclado.nextInt();
        return valor;
    }
     public static int leerIntMin(String mensaje, int minimo) {
        Scanner teclado = new Scanner(System.in);
        int valor;
